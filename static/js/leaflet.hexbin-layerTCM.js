...
L.HexLayer = L.Class.extend({
    ...
    _createHexagons: function (container) {
        var layout = this._layout,
            ...
            // alert("lol"+d) 
                return this._project2([d.geometry.coordinates, d.geometry_name, d.commodity, d.country_code]);    
            }, this),
            bins = layout(data),
    ...
    _project2: function (x) {
        // alert(x)
        var point = this._map.latLngToLayerPoint([x[0][1], x[0][0]]);
        return [point.x, point.y, x[1], x[2], x[3]];
    },
